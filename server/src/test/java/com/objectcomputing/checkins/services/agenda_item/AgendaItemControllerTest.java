 ...
 import static org.junit.jupiter.api.Assertions.assertThrows;		
  ...
  public class AgendaItemControllerTest extends TestContainersSuite implements MemberProfileFixture, CheckInFixture, AgendaItemFixture {		
     ...
     void testCreateNullAgendaItem(){		
      ...
      @Test		
     void testCreateAgendaItemForNonExistingCheckInId() {
      ...
      @Test		
     void testCreateAgendaItemForNonExistingMemberIdId() {
         MemberProfile memberProfile = createADefaultMemberProfile();		
         MemberProfile memberProfileForPDL = createADefaultMemberProfileForPdl(memberProfile);		
      ...
      @Test
      void testCreateAgendaItemByMemberId() {
          MemberProfile memberProfileOfPDL = createADefaultMemberProfile();
          MemberProfile memberProfileOfUser = createADefaultMemberProfileForPdl(memberProfileOfPDL);
    ...
    void testUpdateUnAuthorized() {		
     AgendaItem cAgendaItem = new AgendaItem(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(),"test");		

         final HttpRequest<AgendaItem> request = HttpRequest.PUT("", cAgendaItem);		
        HttpClientResponseException responseException = assertThrows(HttpClientResponseException.class, () ->		
     ...
     void testUpdateNonExistingAgendaItemForMemberId(){		
      ...
      @Test
      void testUpdateAgendaItemForUnrelatedUserByPdl(){
          MemberProfile memberProfile = createADefaultMemberProfile();
          MemberProfile memberProfileForPDL = createADefaultMemberProfileForPdl(memberProfile);
          MemberProfile memberProfileOfMrNobody = createAnUnrelatedUser();
